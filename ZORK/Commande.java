 ...
 * caractères sont "prendre" et "carte").
 * </p>
 * <p>
 * 
 ...
 * le mot commande, alors la valeur du second mot donné a l'initialisation doit
 * etre null</li>
 * </ul>
...
public class Commande {
	 ...
	 * <p>
	 * 
	 * Le premier argument représente un mot commande, sa valeur peut etre null
	 * si le mot commande ne correspond pas a une commande valide. Le second mot
	 * peut également etre null dans le cas ou l'utilisateur n'aurait pas fourni
	 * de second mot dans sa commande.
	 * </p>
	 * 
	 * @param motCommande
	 *            Le mot commande de la commande utilisateur ou null
	 * @param secondMot
	 *            Le second mot de la commande utilisateur ou null
	 */
